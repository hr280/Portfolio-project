...
export default function Work() {
  ...
  return (
    ...
    >
        ...
        <LazyLoadImage
          effect="blur"
          placeholderSrc={content.work3.imgPlaceholder}
          src={content.work3.img}
          alt="phone prototype"
    ...
    <div>
      ...
      >
        <img
          ...
          className="mr-5"
        />
        <a className="text-lg" href="http://ndureshoe.surge.sh/"> <p >Website</p></a>
