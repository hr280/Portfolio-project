...
export default function Work() {
  ...
  return (
    ...
    >
        ...
        <LazyLoadImage
          effect="blur"
          placeholderSrc={content.work4.imgPlaceholder}
          src={content.work4.img}
          alt="phone prototype"
    ...
    <div>
      ...
      >
        <img
          ...
          className="mr-5"
        />
        <a className="text-lg" href="http://redqueenanim.surge.sh/"> <p >Website</p></a>
