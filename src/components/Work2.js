...
export default function Work() {
  ...
  return (
    ...
    >
        ...
        <LazyLoadImage
          effect="blur"
          placeholderSrc={content.work2.imgPlaceholder}
          src={content.work2.img}
          alt="phone prototype"
    ...
    <div>
      ...
      >
        <img
          ...
          className="mr-5"
        />
        <a className="text-lg" href="http://hrcovid-19.surge.sh/"> <p >Website</p></a>
